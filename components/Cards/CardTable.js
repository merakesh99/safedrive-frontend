            ...
            <tbody>
              ...
              {data.map((a) => (
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap"> <i className="fas fa-circle text-orange-500 mr-2"> </i>Active</td>
                    ...
                    <td  class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">{a.alert_time}</td>
                </tr>
                                        ))} 
