...
const CarList = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                console.log("json_DATA: ", json.data.cars);
                setData(json.data.cars);
                //console.log("DATA: ", data);
    ...
    const getData = () => {
        ...
        axios.get(url, { headers })
            .then((getData) => {
                console.log("geeet",getData)
                setData(getData.data.data.cars);
            }, [])
    }
        ...
        <>
            ...
            <div className='' style={{ marginTop: "190px", marginLeft: "200px" }}>
                ...
                <section className="cart-section section-b-space">
                    <Container>
                        <h1 className="text-blueGray-600 text-center mb-3 font-bold">List of Cars</h1><hr />
                        <Row>
                            <Col sm="12">
                                    ...
                                    <tbody>
                                        {data.map((a) => (
                                            <tr>
                                                ...
                                                <td>
                                                    <b>{a.manufacture_company}</b>
                                                </td>
                                                <td>
                                                    <b>{a.model_no}</b>
                                                </td>
                                                <td>
                                                    <b>{a.manufacture_year}</b>
                                                </td>
                                                {/* <td>
